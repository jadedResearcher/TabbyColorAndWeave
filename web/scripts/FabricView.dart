...
class FabricView {
    ...
    void renderToParent(Element parent, Element controls, Element stats, Element warpingGuide) {
        ...
        syncPatternToWarp(fabric.warpPatternStart);
        syncPatternToWeft(fabric.weftPatternStart);
    ...
    void renderWarpingGuide() {
        int length = Util.getTiniestWeavingPatternLength(fabric.exportWarpPattern());
